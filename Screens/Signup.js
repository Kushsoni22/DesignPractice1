    ...
    <View style={{flex: 1, backgroundColor: 'white'}}>
      ...
      <View style={styles.mainFacebook}>
        ...
        <View style={styles.placeh}>
          <TextInput placeholder="Name" placeholderTextColor="#7C8BA0" />
        </View>
        <View style={styles.placeh}>
          <TextInput
      ...
      <View style={styles.checkbox}>
        ...
        <Text style={styles.terms}>
          I am agree to The <Text style={styles.SignIn}>Terms of Service</Text>
          <Text> </Text>
      ...
      <View style={styles.TextDisplay}>
        <Text style={{color: '#3B4054', fontSize: 13}}>
          Do you have account?{' '}
        </Text>
